...
- Provided in bootstrap.welkin file or similar. Main module is welkin, which
  needs to:
...
that the final product, the syntax + semantics checkers and the information
organization, can be externally seen!

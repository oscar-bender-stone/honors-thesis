...
[TODO: decide if words are the ONLY things that automatically interpret fields,
for simplicity. LIkely to be easier to do this *internally*]
#remark[
  For simplicity, we will _interpret_ words as handles, internally generated by
  an implementation. The original value will be stored separately; see @syntax
  for details.]

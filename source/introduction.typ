...
- *Kolmogorov complexity:* Andrey Kolomogorov founded Algorithmic Information Theory, independently connecting Shannon's work to computability.


However, these theories lack a suitable _semantics_. These were expanded upon in Scott domains, which have been succesful in projects like Prolog. Nevertheless _none_ of these theories adequaltey explain what _information_ is:

- *Knowledge Graphs* _encode_ this structure through First Order Logic, but fall apart through contradictions or fallacious axioms. These can be recitied through logics like Relevant logic, but the emphasis is placed on _truth_ rather than _structure_. This falis to provide the notion that information can be false.

- *Shannon entropy* and *Kolmogorov complexity* provide a _measure_ of information, not an exact notion of information itself. In the former, this is measured with random strings and focuses on binary strings, whereas the latter gets closer to computation yet studies a _minimum size_, not the properties of a Turnig machine witnessing this bound.

- *Scott domains* come close to providing a semantic basis, but ultimately focus on the _hierarchical structure_, and not the _connections between domains_.

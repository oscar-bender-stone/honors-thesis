...
#show: ams_article.with(
  ...
  abstract: [This thesis proposes a universal information language called
    Welkin. We introduce its use cases, as well as rigorously define its rules
    and syntax. We prove that the syntax is unambiguous, and that Welkin can
    express any concept and proof recognized by some computer program. We
